    ...
    return new Object[][]
      {
        ...
        { "FIND(\"b\";\"ABC\";1)", FormulaErrorValue.ERROR_NOT_FOUND_VALUE },
        { "FIND(\"b\";\"bbbb\")", new BigDecimal( 1 ) },
        { "FIND(\"b\";\"bbbb\";2)", new BigDecimal( 2 ) },
        { "FIND(\"b\";\"bbbb\";2.9)", new BigDecimal( 2 ) },
        { "FIND(\"b\";\"bbbb\";0)", FormulaErrorValue.ERROR_INVALID_ARGUMENT_VALUE },
        { "FIND(\"b\";\"bbbb\";0.9)", FormulaErrorValue.ERROR_INVALID_ARGUMENT_VALUE },
      };
  }
}
